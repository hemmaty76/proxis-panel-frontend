export const fa = {
    ...
    sidebar: {
        ...
        menu: {
            ...
            support: 'پشتیبانی و ثبت پیشنهاد'
        }
    },
    usersManagement: {
        currency: 'تومان',
    ...
    servicesManagement: {
        ...
        labels: {
            ...
            forms: {
                ...
                editCategoryTitle: 'ویرایش دسته‌بندی و تعیین فروش',
                saveCategory: 'ذخیره تغییرات',
                ...
                visitorTestAllow: 'امکان ایجاد کانفیگ تستی توسط ویزیتور'
            },
            tables: {
                typeName: 'نام نوع سرویس',
                description: 'توضیحات',
    ...
    visitor: {
        ...
        testConfig: {
            ...
            rules: {
                ...
                rule3: 'هزینه اولیه ساخت کانفیگ تست بدون درصد ادمین و ویزیتور از موجودی شما کسر خواهد شد و برای مغازه‌دار رایگان است.',
    ...
    support: {
        title: 'پشتیبانی و ثبت پیشنهاد',
        warning: 'فقط در صورت قطعی سرویس‌ها به پشتیبان پیام دهید. در زمان قطعی سراسری هیچ مسئولیتی وجود ندارد و سرویس‌هایی که دارای تاریخ انقضا هستند اگر تمام شوند تمدید نخواهند شد.',
        qualityDesc: 'تلاش ما همواره ارائه بالاترین کیفیت و پایداری برای سرویس‌های شماست. در صورت نیاز به راهنمایی یا ثبت انتقادات و پیشنهادات، از فرم زیر استفاده کنید.',
        placeholder: 'متن پیام خود را اینجا بنویسید...',
        sendBtn: 'ارسال پیشنهاد یا انتقاد',
        sending: 'در حال ارسال...',
        sendSuccess: 'پیام شما با موفقیت ارسال شد.',
        sendError: 'خطا در ارسال پیام. لطفاً دوباره تلاش کنید.',
        telegramTitle: 'ارسال گزارش خرابی در تلگرام',
        telegramBtn: 'ارسال پیام در تلگرام',
        suggestionTitle: 'ثبت انتقاد یا پیشنهاد',
